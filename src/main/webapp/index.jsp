...
<body>
    ...
    <main>
        ...
        <section class="hero" role="img" aria-label="Hero banner">
            <div class="container">
                <h1>Gowtham Trendy Hub — Premium Picks</h1>
                <p>Discover the latest trends in Hub, technology and accessories — curated just for you. Enjoy limited-time deals and free shipping on selected items.</p>
                <div>
